...
/**
 * Enable reading file extension from dynamic parameters of url (include/image_cache.cls.php: function resolve_url)
 *
 * If this setting is set to true, DOMPDF will try to find image extension in dynamic part of url first
 *
 * @var bool
 */
