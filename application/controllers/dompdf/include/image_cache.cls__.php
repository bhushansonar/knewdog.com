...
class Image_Cache {
 ...
 /**
 2:    * Resolve and fetch an image for use.
 3:    *
 4:    * @param string $url        The url of the image
 5:    * @param string $proto      Default protocol if none specified in $url
 6:    * @param string $host       Default host if none specified in $url
 7:    * @param string $base_path  Default path if none specified in $url
    * @return array             An array with two elements: The local path to the image and the image extension
*/
