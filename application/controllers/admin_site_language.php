...
class Admin_site_language extends CI_Controller {
    ...
    */
    public function index()
    {
        ...
        $config['base_url'] = base_url().'kd2a2a0u1g4/sitelanguage';
        ...
        //load the view
        $data['main_content'] = 'kd2a2a0u1g4/site_language/list';
			  ...
			  //print_r($data['upload_data']); die;
			   if (isset($data['upload_data'])) {
                ...
                if($this->site_language_model->store_language($data_to_store)){
					...
					redirect('kd2a2a0u1g4/sitelanguage/');
...
//$data['main_content'] = 'kd2a2a0u1g4/site_language/list';
        ...
        $data['main_content'] = 'kd2a2a0u1g4/site_language/add';
        $this->load->view('kd2a2a0u1g4/includes/template', $data);  
  ...
  //echo "hi"; die;
        ...
        //load the view
        $data['main_content'] = 'kd2a2a0u1g4/site_language/edit';
        $this->load->view('kd2a2a0u1g4/includes/template', $data);            
