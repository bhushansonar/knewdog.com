...
class Admin_products extends CI_Controller {
    ...
    */
    public function index()
    {
        ...
        //pagination settings
        $config['per_page'] = 5;
        $config['base_url'] = base_url().'kd2a2a0u1g4/products';
        ...
        //load the view
        $data['main_content'] = 'kd2a2a0u1g4/products/list';
    ...
    public function add()
    {
        ...
        $data['manufactures'] = $this->manufacturers_model->get_manufacturers();
        //load the view
        $data['main_content'] = 'kd2a2a0u1g4/products/add';
        $this->load->view('kd2a2a0u1g4/includes/template', $data);  
    }       
    ...
    public function update()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
            ...
            if ($this->form_validation->run())
            {
                ...
                redirect('kd2a2a0u1g4/products/update/'.$id.'');
        ...
        $data['manufactures'] = $this->manufacturers_model->get_manufacturers();
        //load the view
        $data['main_content'] = 'kd2a2a0u1g4/products/edit';
        $this->load->view('kd2a2a0u1g4/includes/template', $data);            
