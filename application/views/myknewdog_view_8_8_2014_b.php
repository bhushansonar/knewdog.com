    ...
    <section class="knewdog findnewsletter" id="container">
        <section id="knewdog_leftbar">
            <div class="knewdog_leftbar_inner">
                <div id="tabsholder">
                    <ul class="tabs">
                        <li style="line-height:33px;" onclick="display_tabs(this.id)" id="tab_1" style=""><?php echo _clang(MY_PROFILE); ?></li>
                                ...
                                0; $i <
                                    ...
                                    <div id="delete_<?php echo $schedule[$i]['schedule_id'] ?>">
                                        <label><span><?php
                                                echo ($i +
                                                1);
                                                ?>)</span><div style="display: inline-block; width: 510px;"> <?php echo $schedule[$i]['sending'] ?> <?php
                                                ...
                                                echo $every_d = "every " . $every_temp . " " . $senddata;

                                                // echo ($schedule[$i]['every'])
                                                //       ? "every " . $schedule[$i]['every'] . " Week"
                                                //     : ""
                                                ?> 
                                                <?php
                                                    echo ($schedule[$i]['weeks_on']) ? "on " . $schedule[$i]['weeks_on'] : ""
                                                    ?> at <?php
...
<?php } ?>
                            ...
                            <div><label><?php echo _clang(DATE_OF_REGI); ?></label><?php
                                ...
                                ?></div>
                            <div><label><?php echo _clang(END_OF); ?>:</label><?php echo _clang(YOUR_ACCOUNT); ?></div>
                            <?php
