...
if ($cls == 'subscribe_1') {
	...
	<div class="jumpmenu ' . get_if_free_user('class_free_user') . '"> 
        ...
        for ($i = 0; $i < count($schedule); $i++) {
            ...
            $data .='<option value="' . $schedule[$i]['schedule_id'] . '">' . $final_sending_content . " " . $every_d . " " . $days_value . " " . _clang(AT) . " " . date("H.i", strtotime($schedule[$i]['at'] . ":00:00")) . " " . _clang(TO_EMAIL) . " " . $schedule[$i]['sending_to_email'] . " " . $ends_in . "</option>";
        }
        $data .='</select>
    </div>
    ...
    for ($i = 0; $i < count($schedule); $i++) {
        ...
        $data .='<option ' . $selected_edit . ' value="' . $schedule[$i]['schedule_id'] . '">' . $final_sending_content . " " . $every_d . " " . $days_value . " " . _clang(AT) . " " . date("H.i", strtotime($schedule[$i]['at'] . ":00:00")) . " " . _clang(TO_EMAIL) . " " . $schedule[$i]['sending_to_email'] . " " . $ends_in . "</option>";
    }
    $data .='</select>
    </div>
    <div class="link_button">
