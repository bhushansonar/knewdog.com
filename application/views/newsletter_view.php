                                    ...
                                    <div class="selectgroup">
                                        ...
                                        <div class="select cancel_button"><label></label>
                                            <div style="float:right;" class="summary_cancel">
                                                ...
                                                <input  class="btn btn_main" style="font-size: 14px; margin-top: 1px; padding: 3px 5px;"  value="<?php echo _clang(SEARCH_BUTTON) ?>" type="submit">
                            ...
                            <div class="dashreview">
                                <div class="review_img"><a <?php echo $onclick; ?>  href="<?php echo $newsletter_inner_url; ?>">
                                        <?php if (!empty($newsletter[$i]['screenshot'])) { ?>
                                            <img style="width:79px;" src="<?php echo base_url(); ?>uploads/<?php echo $newsletter[$i]['screenshot']; ?>" alt="Review Image">
                                        <?php } else { ?>
                                ...
                                <div class="review_detail">
                                    ...
                                    <label style="color:#808080; float:left;"><?php echo _clang(AUTHOR); ?> </label><span style="float: left; width: 315px;"><?php echo $newsletter[$i]['author_name'] ?><?php //echo $newsletter[$i]['headline']      ?></span>
                                    <?php
                                    ...
                                    <span style="float:left; position:relative" class="rating_hover">
                                        <span style=" display: inline-block; vertical-align: text-bottom;" data-productid="<?php echo $newsletter[$i]['newsletter_id']; ?>" title="<?php echo $avg_round; ?>" data-rateit-resetable="false" data-rateit-value="<?php echo $avg_round; ?>" data-rateit-ispreset="true" data-rateit-reset="false" data-rateit-readonly="<?php echo $readonly ?>" class="rateit rateit9"></span>
                                        ...
                                        <?php if (count($get_news_user_id) > 0) { ?>
                                            <span style="left:0; top:20px;"  class="rating_popup">
                                    ...
                                    <div class="description">
                                        ...
                                        <?php echo $newsletter[$i]['headline']; ?>
                                    </div>
                                    <?php
                            ...
                            <?php for ($i = 0; $i < count($mynl_newsletter); $i++) { ?>
                                <div class="dashreview" id="unsubscribe_<?php echo $mynl_newsletter[$i]['newsletter_id'] ?>">
                                    <div class="review_img">
                                        <a href="<?php echo site_url('newsletter/specific') . "/" . url_title($mynl_newsletter[$i]['newsletter_name'], 'dash', true) . "/" . $mynl_newsletter[$i]['newsletter_id'] ?>">
                                            <?php if (!empty($mynl_newsletter[$i]['screenshot'])) { ?>
                                                <img style="width:79px;" src="<?php echo base_url(); ?>uploads/<?php echo $mynl_newsletter[$i]['screenshot']; ?>" alt="screenshot">
                                            <?php } else { ?>
                                                <img style="width:79px;" src="<?php echo base_url(); ?>assets/img/authornewsletter.png" alt="authornewsletter">
                                            <?php } ?>
                                        </a>
                                    </div>
                                    <div class="review_detail">
                                        ...
                                        ?>
                                        <span  style="float:left; position:relative" class="rating_hover">
                                            <span style=" display: inline-block; vertical-align: text-bottom;" data-productid="<?php echo $mynl_newsletter[$i]['newsletter_id']; ?>" title="<?php echo $avg_round; ?>" data-rateit-resetable="false" data-rateit-value="<?php echo $avg_round; ?>" data-rateit-ispreset="true" data-rateit-reset="false" data-rateit-readonly="<?php echo $readonly ?>" class="rateit rateit9"></span>
                                    ...
                                    <div class="review_subscribe">
                                        ...
                                        if (!empty($user_id)) {
                                            ...
                                            if (count($subscribe) > 0) {
                                                ...
                                                <label onclick="popups_ajax_unsubscribe('unsubscribe', '<?php echo $mynl_newsletter[$i]['newsletter_id'] ?>', '<?php echo $user_id ?>')" style="color: #9a7f82; cursor:pointer; float: right;font-size: 11px;font-weight: bold;margin: 0 84px;"><?php echo _clang(UNSUBSCRIBE_BUTTON) ?></label>
                                                <a href="<?php echo site_url("newsletter/display-rate" . "/" . $mynl_newsletter[$i]['newsletter_id']); ?>"><img src="<?php echo base_url(); ?>assets/img/evaluate.png" class="evaluate" alt="">
                                                    ...
                                                    if ($get_news_user_id == true) {
                                                        ?>
                                                        <label style="color: rgb(154, 127, 130); float: right; font-size: 11px; font-weight: bold; margin: -31px 22px;"><?php echo _clang(EVALUATE_BUTTON) ?></label>
                                                    <?php } else { ?>
                                                        <label style="color: #9a7f82;float: right;font-size: 11px;font-weight: bold;margin: -13px 22px;"><?php echo _clang(EVALUATE_BUTTON) ?></label>
                                                    <?php } ?>
                                                </a>
                                    ...
                                    if ($subscribed_1[0]['schedule_id'] != 0) {
                                        ...
                                        $every = _clang(EVERY) . " " . $every_temp . " " . $senddata;

                                        $days_value = "";
                                        if (!empty($get_schedule_by_id[0]['weeks_on'])) {
                                            $weeks_on_d_remove_comma = str_replace(',', ' ', $get_schedule_by_id[0]['weeks_on']);
                                        ...
                                        } elseif (!empty($get_schedule_by_id[0]['monthly_on'])) {
                                            $monthly_weekday_day[] = $get_schedule_by_id[0]['monthly_weekday_day'];
                                        ...
                                        $sending_value = $get_schedule_by_id[0]['sending'];
                                        ...
                                        <div class="sendingscheduale">
                                            <b><?php echo _clang(SENDING_SCHEDULE); ?></b><label>
                                                <?php
                                                $monthly_content = "";
