    ...
    <section class="knewdog findnewsletter" id="container">
        <div id="knewdog_leftbar">
            <div class="knewdog_leftbar_inner">
                ...
                <!--------------------------------------------Section 1 --------------------------------------------------->
                <div class="section" style="display:none;" id="section_1">
                    ...
                    <div id="vasPhoto_uploads_Status" class="profilepicture" style="position:relative;">
                        <div id="view">
                            ...
                            if (is_file($sTempFileName)) {
                                ?>
                                <div onclick="remove_avatar();" class="remove_icon"><img alt="" style="width:23px;" src="<?php echo site_url('assets/img/list-remove.png') ?>" /></div>
                                <img alt="" style="max-width:161px;" src="<?php echo site_url('uploads/avatar') . "/" . $user[0]['avatar']; ?>" >
                            <?php } else { ?>
                                <img alt="" src="<?php echo base_url(); ?>assets/img/avatarpic.png">
                            <?php } ?>
                        </div>
                        ...
                        <form style="margin-top:10px;" id="profilepicture_detail" class="autosubmit" method="POST" action="./ajax-update.php">
                            <div class="firstname">
                                <label><?php echo _clang(FIRSTNAME); ?>&nbsp;</label> <div><label><?php
                                        ...
                                        ?></label></div>
                                <span class="editbtn"><span style="cursor:pointer;" onclick="popups_ajax('profile', '1')" ><img alt="" src="<?php echo base_url(); ?>assets/img/edit.png"></span></span>
                            </div>
                            <div class="firstname">
                            ...
                            <div style="margin-top:15px;">
                                ...
                                <span class="editbtn"><span onclick="popups_ajax('profile', '2')" style=" cursor:pointer;"><img alt="" src="<?php echo base_url(); ?>assets/img/edit.png"></span></span>
                            </div>
                            <div>
                                ...
                                <?php } ?>
                                <?php
                                if (show_additional_email_link() == true) {
                                    $display_additional_email = $this->additional_email_model->get_additional_email_by_field(array("user_id"), array($user_id));
//                                    echo '<pre>'; print_r($display_additional_email);
                                    for ($e = 0; $e < count($display_additional_email); $e++) {
                                        ?>
                                    ...
                                    <?php } ?>
                                    <span class="editbtn"><span onclick="popups_ajax_additional_email('additional_email', '1')" style=" cursor:pointer;"><img alt="" src="<?php echo base_url(); ?>assets/img/edit.png"></span></span>
                                <?php } ?>
                            </div>
                            <div style="margin-top:15px;">
                                ...
                                <?php } ?>
                                <span class="editbtn"><span onclick="popups_ajax('profile', '5')" style=" cursor:pointer;"><img alt="" src="<?php echo base_url(); ?>assets/img/edit.png"></span></span>
                            </div>
...
//                            echo $a=date('j, F Y',strtotime($this->session->userdata('last_login')));
                        ...
                        <form id="gotoprofile" action="<?php echo site_url('myknewdog'); ?>" method="post">
                            ...
                            <div class="laungages_con language_id">
                                ...
                                if (!empty($user[0]['language_id'])) {
                                    ...
                                    0; $i <
                                        ...
                                        ?>
                                        <span id="del_<?php echo $newsletter_language_ids[$i] ?>"><?php echo $newsletter_language[0]['language_longform'] ?><a onclick="profile_delete('language_id',<?php echo $newsletter_language_ids[$i] ?>, '<?php echo $user_id ?>')" style="cursor:pointer;"><img alt="" src="<?php echo base_url(); ?>assets/img/cancell.png"></a></span>
                                    <?php } ?>
                                <?php } ?>
                            ...
                            <div class="interests_con user_interests">
                                ...
                                if (!empty($user[0]['user_interests'])) {
                                    ...
                                    0; $i <
                                        ...
                                        ?>
                                        <span id="del_<?php echo $newsletter_keyword_ids[$i] ?>"><?php echo $word ?><a onclick="profile_delete('user_interests',<?php echo $newsletter_keyword_ids[$i] ?>, '<?php echo $user_id ?>')" style="cursor:pointer;"><img alt="" src="<?php echo base_url(); ?>assets/img/cancell.png"></a></span>
                                    <?php } ?>
                                <?php } ?>
                ...
                <!--------------------------------------------Section 2 --------------------------------------------------->
                <div class="section" style="display:none;" id="section_2">
                                    ...
                                    <div class="review_img">
                                        <a href="<?php echo site_url('newsletter/specific') . "/" . url_title($mynl_newsletter[$i]['newsletter_name'], 'dash', true) . "/" . $mynl_newsletter[$i]['newsletter_id']; ?>">
                                            <?php if (!empty($mynl_newsletter[$i]['screenshot'])) { ?>
                                                <img style="width:79px;" src="<?php echo base_url(); ?>uploads/<?php echo $mynl_newsletter[$i]['screenshot']; ?>" alt="Review Image">
                                            <?php } else { ?>
                                                <img style="width:79px;" src="<?php echo base_url(); ?>assets/img/authornewsletter.png" alt="Review Image">
                                            <?php } ?>
                                        </a>
                                    </div>
                                            ...
                                            if (count($subscribe) > 0) {
                                                ...
                                                <div style="display: inline-block; margin-right: 8px;">
                                                    <div style="display: block">
                                                        <img style="cursor:pointer;" onclick="popups_ajax_unsubscribe('unsubscribe', '<?php echo $mynl_newsletter[$i]['newsletter_id'] ?>', '<?php echo $user_id ?>')" src="<?php echo base_url(); ?>assets/img/unsubscribe.png" alt="">
                                                    </div>
                                                    <div style="display: block">
                                                        <label onclick="popups_ajax_unsubscribe('unsubscribe', '<?php echo $mynl_newsletter[$i]['newsletter_id'] ?>', '<?php echo $user_id ?>')" style="color: #9a7f82; cursor:pointer; font-size: 11px;font-weight: bold;"><?php echo _clang(UNSUBSCRIBE_BUTTON) ?></label>
                                                    </div>
                                                </div>
                                                <div style="display:inline-block;">

                                                    <div style="display: block;cursor: pointer">
                                                        <a href="<?php echo site_url("newsletter/display-rate" . "/" . $mynl_newsletter[$i]['newsletter_id']); ?>">
                                                            <img src="<?php echo base_url(); ?>assets/img/evaluate.png" class="evaluate" alt="">
                                                            <?php
                                                    ...
                                                    <div style="display: block">
                                                        <label style="color: rgb(154, 127, 130);  font-size: 11px; font-weight: bold;"><?php echo _clang(EVALUATE_BUTTON) ?>
                                                        </label>
                                                    </div>
                ...
                <!--------------------------------------------Section 3 --------------------------------------------------->
                <div class="section" style="display:none;" id="section_3">
                        ...
                        <div class="<?php echo get_if_free_user('class_free_user') ?>">
                            ...
                            <form id="schedule_form" name="schedule_form" method="post" action="<?php echo site_url('myknewdog/schedule') ?>">
                                ...
                                <div class="sendingtoemail">
                                    ...
                                    <input type="hidden" class="to_email" name="to_email" value="<?php echo $language_keyword_to_email ?>" />
            ...
            schedule_summary('site');" type="radio" id="Monthly" value="Monthly" name="sending"><?php echo _clang(MONTHLY); ?></label>
                                    ...
                                    <div class="everyweekson row">
                                        ...
                                        <div style="width:220px; display:none" class="weeks_on_2">
                                            <div><input type="radio" name="monthly_on" value="day_of_the_month" onclick="schedule_summary('site');"><label><?php echo _clang(DAY_OF_MONTH) ?></label>
                                                <span id="day_of_the_month">
                                                    <select onchange="schedule_summary('site');" style="width:100px;" id="current_Daily" name="day_of_the_month" title=""><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="last_day"><?php echo _clang(LAST_DAY); ?></option></select>
                                                </span>
                                            </div>
                                            <div style="width: 179px;">
                                                <input type="radio" id="weekday" name="monthly_on" value="weekday" onclick="schedule_summary('site');"><label style="margin-bottom: 35px;"><?php echo _clang(WEEKDAY) ?></label>
                                                <span id="weekday">
                                                    <select style="width:50px;" onchange="schedule_summary('site');" id="" name="monthly_weekday_count" title=""><option value="1">1.</option><option value="2">2.</option><option value="3">3.</option><option value="4">4.</option><option value="5">5.</option></select>
                                                </span><br/>
                                                <span style="float: right;">
                                                    <select style="width:91px;" onchange="schedule_summary('site');"  id="" name="monthly_weekday_day" title=""><option value="Monday"><?php echo _clang(MONDAY); ?></option><option value="Tuesday"><?php echo _clang(TUESDAY); ?></option><option value="Wednesday"><?php echo _clang(WEDNESDAY); ?></option><option value="Thursday"><?php echo _clang(THURSDAY); ?></option><option value="Friday"><?php echo _clang(FRIDAY); ?></option><option value="Saturday"><?php echo _clang(SATURDAY); ?></option><option value="Sunday"><?php echo _clang(SUNDAY); ?></option></select>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
...
//                            print_r($schedule);exit;
                            if (get_if_free_user('class_free_user') != 'free_user') {
                                for ($i = 0; $i < count($schedule); $i++) {
                                    ...
                                    $days_value = "";
                                    //echo "<pre>";print_r($schedule[$i]['monthly_on']);
                                    if (!empty($schedule[$i]['weeks_on'])) {
                                        ...
                                        //$month_value = implode(", ", $monthly_on);
                                        //echo $monthly_on;
                                    }
...
//                                    echo $schedule[$i]['day_of_the_month'];
                                    ...
                                    <div id="delete_<?php echo $schedule[$i]['schedule_id'] ?>">
                                        <label><span><?php
                                            ...
                                            <div style="display: inline-block; width: 510px;">
                                                <?php echo $final_sending_content;
                                                ?> <?php
                                                ...
                                                //new lines
                                                echo ($schedule[$i]['monthly_on'] == 'day_of_the_month') ? _clang(ON) . " " . $last_days_main_value . " " : " ";
                                                echo ($schedule[$i]['monthly_on'] == 'weekday') ? _clang(ON) . " " . $schedule[$i]['monthly_weekday_count'] . " " . $monthly_on . " " : "";
                                                ?>
                                                <?php echo _clang(AT) ?><?php echo " " . date("H.i", strtotime($schedule[$i]['at'] . ":00:00")) ?> <?php echo _clang(TO) ?> <?php echo $schedule[$i]['sending_to_email'] ?>
                                                <?php
                                        ...
                                        <span class="editbtn" style="width:50px;">
                                            <a title="Edit schedule" style="margin-right:8px;" onclick="popups_ajax_schedule('schedule', '<?php echo $schedule[$i]['schedule_id'] ?>')" href="javascript:void(0)"><img src="<?php echo base_url(); ?>assets/img/edit.png" alt=""></a>
                                            <a title="Delete schedule" onclick="popups_ajax_schedule_delete('delete_schedule', '<?php echo $schedule[$i]['schedule_id'] ?>')" href="javascript:void(0)"><img src="<?php echo base_url(); ?>assets/img/wrong.png" alt=""></a>
                                        </span>
                ...
                <!--------------------------------------------Section 4 --------------------------------------------------->
                <div class="section" style="display:none;" id="section_4">
                    <div class="accountsetting">

                        <div style="margin-top:15px;" class="login_profile">
                            <div class="accountsetting_title"><?php echo _clang(LOGIN_DATE); ?></div>
                            <div><label><?php echo _clang(USER_MK); ?></label><?php echo $user[0]['username'] ?><span style="color:#808080; float:right;"> <a onclick="popups_ajax('account_settings', '5')" href="javascript:void(0);"><img src="<?php echo base_url(); ?>assets/img/edit.png" alt=""></a></span></div>
...
<!-- <a href="#"><img src="<?php echo base_url(); ?>assets/img/true.png"></a>I'd like to receive HTML e-mails.-->
                        ...
                        <div class="login_profile">
                            ...
                            <div><label><?php echo _clang(DATE_OF_REGI); ?></label><?php
                                if ($user[0]['date_of_registration'] == '0000-00-00 00:00:00') {
                                    echo "No Registration Date Avialable";
                                } else {
...
//                                exit;
                                $end_term = "";
                                if ($this->session->userdata('type_of_membership') == "FREE" || $this->session->userdata('type_of_membership') == "power_admin") {
                                    echo $end_term = _clang(YOUR_ACCOUNT);
                                } else {

                                    $year_data = _clang(NO_DATE);
...
?>';
        ...
        function schedule_summary(loc) {
            ...
            if (loc == 'site') {
                ...
                if (($('#schedule_form_popup #every_field').is(":empty")) || current_id != 'current_' + sending) {
                    if (sending == 'Daily') {
                        ...
                        var on = ON;
                        monthly_on_checked1 = "";
                        monthly_on_checked1 = $('input[name=monthly_on]:checked', '#schedule_form_popup').val();
                        //alert(monthly_on_checked1);
                        if (monthly_on_checked == 'weekday') {
                            monthly = $('select[name=monthly_weekday_day]', '#schedule_form_popup').val();
                            monthly_count = $('select[name=monthly_weekday_count]', '#schedule_form_popup').val();
                        } else if (monthly_on_checked == 'day_of_the_month') {
                            day_of_month = $('select[name=day_of_the_month]', '#schedule_form_popup').val();
                        }
            ...
            var sending_to_email_d = sending_to_email;
            //console.log(sending_to_email_d);
            if (ends == "Never") {
            ...
            //alert(on);
//            console.log(sending_d);
//            console.log(every_d);
//            console.log(weeks_on_d);
...
//            console.log(on);
//            console.log(loc);
            setTranslateKeyword(sending_d, every_d, weeks_on_d, day_of_month, monthly_count, monthly, at_d, sending_to_email_d, ends_in, on, to_email, loc);
