<main>
    ...
    <section class="knewdog findnewsletter" id="container">
        <section id="knewdog_leftbar">
            <div class="knewdog_leftbar_inner">
                ...
                <section>
                        ...
                        <div class="dashreview fullwidth_left">
                            <div class="review_img">
                                <?php if (!empty($newsletter[0]['screenshot'])) { ?>
                                    <a class="fancybox" href="<?php echo base_url(); ?>uploads/<?php echo $newsletter[0]['screenshot']; ?>">
                                        <img style="width:100px; " src="<?php echo base_url(); ?>uploads/<?php echo $newsletter[0]['screenshot']; ?>" alt="">
                                    </a>                                   
                                <?php } else { ?>
                                    <a  href="javascript:void(0)">
                                        <img style="width:100px; " src="<?php echo base_url(); ?>assets/img/authornewsletter.png" alt="">
                                    </a>                                   
                                <?php } ?>
                            </div>
                            <div class="review_detail specific_review_detail">
                                ...
                                <div class="subscriptiondetail specific_subscriptiondetail">
                                    ...
                                    ?>
                                    <span style="position:relative;" class="rating_hover">
                                    ...
                                    <label style="color:#808080; margin-top:10px; float:left; width:100%;"><?php echo $count_subscribed_3; ?> <?php echo _clang(SUBSCRIBERS); ?><br/>
                                        ...
                                        <?php echo _clang(LATEST_EDITION); ?>: <?php echo date('j, F Y', strtotime($newsletter[0]['last_updated_date'])); ?><br/>
                                    </label> 
                                </div>
                                <div class="review_subscribe review_subscribe_<?php echo $newsletter[0]['newsletter_id']; ?>">
                                    ...
                                    if (!empty($user_id)) {
                                        ...
                                        <?php } else { ?>
                                            <img style="cursor:pointer;" onclick="popups_ajax('subscribe_1', '<?php echo $newsletter[0]['newsletter_id'] ?>', '<?php echo $user_id ?>')" src="<?php echo base_url(); ?>assets/img/subscribe_specificpage.png" alt="">
                    ...
                    <article>
                        <?php if (!empty($archive_newsletter)) { ?>
                            <div class="fullwidth_left details">
                                ...
                                <?php if (count($archive_newsletter) > 0 && $newsletter[0]['newsletter_relation'] == 'parent') { ?>
                                    <div class="datte_time">
                                        <?php for ($d = 0; $d < count($archive_newsletter); $d++) { ?>
                                            ...
                                            <date><a class="fancybox fancybox.iframe" href="<?php echo site_url('ajax_call/popups_ajax/archive_newsletter/' . $archive_newsletter[$d]['newsletter_id']) ?>"><?php echo $archive_newsletter[$d]['added_date']; ?></a></date>
                                        <?php }
                                        ?>
        <!--<a class="datelink" href="#">more...<img src="<?php echo base_url(); ?>assets/img/more.png"></a>-->
                                        ...
                                        if (!empty($user_id)) {
                                            ...
                                            if (count($subscribe) > 0) {
                                                ?>
                                                                                                                                                               <!-- <span style="float: right; margin-top: 20px; text-align: center; color:#808080; font-size: 11px;">You are already subscribed<br>Go to ”<u><span style="cursor:pointer;" onclick="display_tabs('tab_2')">My Newsletters</u>”<br>to manage<br>your subscriptions.</span>-->
                                            <?php } else { ?>
                                                <img style="cursor:pointer; margin-top:0;" onclick="popups_ajax('subscribe_1', '<?php echo $newsletter[0]['newsletter_id'] ?>', '<?php echo $user_id ?>')" src="<?php echo base_url(); ?>assets/img/subscribe_specificpage.png" alt="">
                                ...
                                <?php } else { ?>
                                    <h1 style="clear: both; color: black; text-align: center; margin-top: 20px; margin-bottom:20px;"><?php echo _clang(NO_ARCHIVE); ?></h1>	
                                <?php }
                                ?>
                            </div>
                        <?php } ?>
                        ...
                        <div class="fullwidth_left details userrating">
                            ...
                            <div class="starrating_detail">
                                <div class="reviewstar">
                                    ...
                                    <div title="<?php echo $avg_round; ?>" style="float:left;margin-top:2px;" data-productid="<?php echo $newsletter[0]['newsletter_id']; ?>" data-rateit-resetable="false" data-rateit-value="<?php echo $avg_round; ?>" data-rateit-ispreset="true" data-rateit-reset="false" data-rateit-readonly="true" class="rateit" id="rateit9">
                                    </div>
