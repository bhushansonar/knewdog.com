...
tinymce.init({
    ...
    <div class="container top">
      ...
      <div class="page-header users-header">
        <h2>
          ...
          <a style="float:right; margin-left:5px;"  href="<?php echo site_url('kd2a2a0u1g4').'/'.$this->uri->segment(2); ?>/process_without_check/<?php echo $this->uri->segment(4); ?>/<?php echo $this->uri->segment(5); ?>" class="btn btn-warning">Process Without Unsubscribe check</a>
          
          <a  href="<?php echo site_url('kd2a2a0u1g4').'/'.$this->uri->segment(2); ?>/process/<?php echo $this->uri->segment(4); ?>/<?php echo $this->uri->segment(5); ?>" class="btn btn-success">Process With Unsubcribe check</a>
        </h2>
      </div>
      <?php
      //form data
	...
	if($this->session->userdata('flash_message1')){
		...
		if(!empty($url_segment_5)){
      		echo form_open_multipart('kd2a2a0u1g4/admin-inbox/update/'.$this->uri->segment(4).'/'.$url_segment_5.'', $attributes);
		}else{
			echo form_open_multipart('kd2a2a0u1g4/admin-inbox/update/'.$this->uri->segment(4).'', $attributes);
			}
      ?>
         <fieldset>
         ...
         <?php }?>
            ...
            <div class="controls">
             ...
             <?php /*?> <textarea class="tinymce ckeditor" name="description"><?php //echo stripslashes($newsletter_clone[0]['description']);?></textarea><?php */?>
              <div><?php echo stripslashes($newsletter_clone[0]['description']);?></div>
             
              <?php /*?><div style="max-height:500px; overflow:auto;"><?php echo stripslashes($newsletter_clone[0]['description']);?></div><?php */?>
          ...
          <div class="form-actions">
           ...
           <a class="btn" href="<?php echo site_url('kd2a2a0u1g4/admin-inbox');?>">Cancel</a>
         	
          
          	<span style="display:none"; id="delete_msg">Are you really sure to delete this Mail?</span>
           
           <a style="margin-left:30px;" class="btn btn-danger complexConfirm" href="<?php echo site_url("kd2a2a0u1g4")?>/admin-inbox/delete/<?php echo $this->uri->segment(4);?>">Delete</a>
