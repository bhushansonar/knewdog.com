    <div class="container top">
      ...
      <div class="page-header">
        <h2>
          Adding Language Database<?php //echo ucfirst($this->uri->segment(2));?>
        </h2>
      </div>
      ...
      echo form_open('kd2a2a0u1g4/languagekeyword/add', $attributes);
      ?>
        <fieldset>
            ...
            <div class="controls">
              <input type="text" id="" name="language_define" value="<?php echo set_value('language_shortcode'); ?>" >
              <!--<span class="help-inline">Woohoo!</span>-->
            </div>
          </div>
          ...
          <div class="form-actions">
           ...
           <a class="btn" href="<?php echo site_url('kd2a2a0u1g4')?>/languagekeyword">Cancel</a>
          </div>
        </fieldset>
