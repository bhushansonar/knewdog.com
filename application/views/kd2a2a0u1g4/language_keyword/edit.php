    <div class="container top">
      ...
      <div class="page-header users-header">
        <h2>
          Updating Language Database<?php //echo ucfirst($this->uri->segment(2));?>
        </h2>
      </div>
...
?>
        <fieldset>
        <?php 
		//echo current_url()." = ".$this->session->userdata('redirect_url');
		//if($this->session->userdata('redirect_url') != current_url()){
