    <div class="container top">
     ...
     /* if($this->session->flashdata('flash_message')){
      ...
      echo form_open('kd2a2a0u1g4/category/update/'.$this->uri->segment(4).'', $attributes);
      ?>
        <fieldset>
        <input type="hidden" value="<?php echo $this->session->userdata('redirect_url')?>" name="redirect_url" />
          ...
          <div class="control-group">
            ...
            <div class="controls">
            <textarea name="<?php echo $site_language[$i]['language_shortcode']?>"><?php echo $category[0][$site_language[$i]['language_shortcode']]?></textarea>
          ...
          <div class="control-group">
            ...
            <div class="controls">
             <select name="status">
             	<option <?php echo $category[0]['status']== 'Active' ? 'selected="selected"' : ''?>  value="Active">Active</option>
                <option <?php echo $category[0]['status']== 'Inactive' ? 'selected="selected"' : ''?> value="Inactive">Inactive</option>
             </select>
              <!--<span class="help-inline">Woohoo!</span>-->
            </div>
          </div>
