    <div class="container top">
      ...
      echo form_open('kd2a2a0u1g4/products/update/'.$this->uri->segment(4).'', $attributes);
      ?>
        <fieldset>
          ...
          <div class="form-actions">
            <button class="btn btn-primary" type="submit">Save changes</button>
             <button class="btn" type=""><a href="<?php echo site_url('kd2a2a0u1g4')?>/products">Cancel</button>
          </div>
        </fieldset>
