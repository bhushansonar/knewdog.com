      ...
      <div class="row">
        <div class="span12 columns">
          <div class="well">
            ...
            echo form_open('kd2a2a0u1g4/products', $attributes);
...
height: 26px;"');
			...
			echo '<a style="margin-left: 12px;vertical-align: middle;" class="btn" href="'.site_url("kd2a2a0u1g4/products/").'">Reset</a>';
			}
            echo form_close();
            ?>
            ...
            <tbody>
              ...
              foreach($products as $row)
              {
                ...
                echo '<td class="crud-actions">
                  <a href="'.site_url("kd2a2a0u1g4").'/products/update/'.$row['id'].'" class="btn btn-info">view & edit</a>  
                  <a href="'.site_url("kd2a2a0u1g4").'/products/delete/'.$row['id'].'" class="btn btn-danger">delete</a>
                </td>';
                echo '</tr>';
              }
              ?>      
