      ...
      <div class="row">
        <div class="span12 columns">
          <div class="well">
            ...
            echo form_open('kd2a2a0u1g4/language', $attributes);
			...
			echo '<a style="margin-left: 12px;vertical-align: middle;" class="btn" href="'.site_url("kd2a2a0u1g4/language/").'">Reset</a>';
			}
            echo form_close();
            ?>
            ...
            <tbody>
              ...
              foreach($language as $row)
              {
                ...
                echo '<td style="text-align:center;" class="crud-actions">
                  <a href="'.site_url("kd2a2a0u1g4").'/language/update/'.$row['language_id'].'" class="btn btn-info">view & edit</a>         
                </td>';
                echo '</tr>';
              }
			  /*<a href="'.site_url("kd2a2a0u1g4").'/language/delete/'.$row['language_id'].'" class="btn btn-danger complexConfirm">delete</a>*/
              ?>      
            </tbody>
          </table>
