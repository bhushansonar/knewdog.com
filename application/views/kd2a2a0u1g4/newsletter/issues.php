...
<div class="container top">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            ...
            <a href="<?php echo site_url("kd2a2a0u1g4/newsletter"); ?>">

                Newsletter<?php //echo ucfirst($this->uri->segment(1));                 ?>
        ...
        <li class="active">
            ...
            <?php //echo ucfirst($this->uri->segment(2)); ?>Issues of newsletter <?php echo $get_newsletter_rand_id; ?>
    ...
    <div class="page-header users-header">
        ...
        <h2 class="head_issue" style="">

            <?php //echo ucfirst($this->uri->segment(2)); ?><span style="float:left;">Issues of&nbsp;</span> <a href="<?php echo site_url('kd2a2a0u1g4/newsletter/update') . "/" . $this->uri->segment(4) ?>">newsletter <?php echo $get_newsletter_rand_id; ?></a>
...
//echo  '<pre>'; print_r($newsletter);
                ...
                echo form_open('kd2a2a0u1g4/newsletter/issues/' . $this->uri->segment(4), $attributes);
                ...
                <select name="order" class="span2">
                    ...
                    <option <?php echo ($order == 'added_date') ? 'selected="selected"' : "" ?> value="added_date">Issue Date</option>
                ...
                if ($search_string_selected) {
                    ...
                    echo '<a style="margin-left: 12px;vertical-align: middle;" class="btn" href="' . site_url("kd2a2a0u1g4/newsletter/issues/" . $this->uri->segment(4)) . '">Reset</a>';
                }
            ...
            <form name="frmList" id="frmList" method="post" action="<?php echo site_url('kd2a2a0u1g4/newsletter/multidelete/' . $this->uri->segment(4)) ?>">
                ...
                <table class="table table-striped table-bordered table-condensed">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th align="center" style="text-align:center;" class="header">SN Id</th>
...
<!--                            <th class="yellow header headerSortDown">Subject</th>-->
                            ...
                            <th style="text-align:center;" class="yellow header headerSortDown">Issue Date</th>
                    ...
                    <tbody>
                        ...
                        foreach ($newsletter as $row) {
                            ...
                            echo '<td style="text-align:center;">' . $row['sn'] . '</td>';
...
//                            echo '<td>' . $row['headline'] . '</td>';
                            ...
                            echo '<td style="text-align:center;">' . $row['added_date'] . '</td>';

                            echo '<td>' . $row['status'] . '</td>';

                            echo '<td style="text-align:center;" class="crud-actions">

                  <a  href="' . site_url("kd2a2a0u1g4") . '/newsletter/update/' . $row['newsletter_id'] . '/' . $this->uri->segment(4) . '" class="btn btn-info">view & edit</a>
