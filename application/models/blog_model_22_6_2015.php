...
//        print_r($array_a);
        ...
        $featured_image_url = base_url() . "uploads/" . $array_a[0]['featured_image'];
        $pathinfo = pathinfo($featured_image_url, PATHINFO_EXTENSION);
        $imagename = md5(time()) . "." . $pathinfo;
//        print_r($phathinfo);
//        die;
        // echo $featured_image_url;
        @copy($featured_image_url, 'uploads/' . $imagename);
//die;
...
//echo '<pre>'; print_r($array_value);
        ...
        $array_a[0]['featured_image'] = $imagename;
    ...
    function delete_blog($id) {
        ...
        $array_a = array();
        $array_a = $query->result_array();
        @unlink("uploads/" . $array_a[0]['featured_image']);
